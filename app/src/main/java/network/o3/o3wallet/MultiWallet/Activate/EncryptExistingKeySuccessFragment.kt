...
import network.o3.o3wallet.Onboarding.CreateKey.Backup.Nep2BackupActivity
...
class EncryptExistingKeySuccessFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        mView = inflater.inflate(R.layout.multiwallet_existing_encryption_success, container, false)
