...
class AdvancedSettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        browserButton.setOnClickListener {
            val url =  "https://s3-ap-northeast-1.amazonaws.com/network.o3.apps/o3cap/index.html" //"https://s3-ap-northeast-1.amazonaws.com/network.o3.apps/testsend/index.html"
